...
//* The geolocation API is a browser API by which we can navigate the position of a location.
...
//* As the name itself means when the data and location is accurate(whenever the browser gets the current position of the user) then the success call back function will be executed otherwise the error message by the call back will be executed.
